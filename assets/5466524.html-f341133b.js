import{_ as r,X as s,Y as a,a0 as e,a1 as i,$ as t,a2 as l,C as c}from"./framework-7dab1287.js";const d={},v=l(`<p>在hibernate中，用criteria实现后台分页方法，不多说了直接看程序吧。</p><p>下面首先根据查询条件和每页记录数获得记录列表：</p><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>/**
  * 根据不同条件获取日志列表
  * @param inter 接口名称
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>代码就这么多，很容易看明白的。</p>`,7),u={href:"http://jiaxy917.javaeye.com/blog/452157",target:"_blank",rel:"noopener noreferrer"};function o(m,b){const n=c("ExternalLinkIcon");return s(),a("div",null,[v,e("p",null,[i("此文转自:"),e("a",u,[i("http://jiaxy917.javaeye.com/blog/452157"),t(n)])])])}const g=r(d,[["render",o],["__file","5466524.html.vue"]]);export{g as default};
