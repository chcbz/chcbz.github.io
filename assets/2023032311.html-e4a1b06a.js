...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样也是可以的。</p><p>最终打出来的exe文件有65M，也不小，jar包的话也就18M，不过exe不需要jvm环境，并且启动后占用60M内存，而直接启动jar文件占用109M内存，相对来说还是有优势。</p>`,16);function j(M,_){const n=l("ExternalLinkIcon");return r(),o("div",null,[f,w,k,e("p",null,[e("a",h,[i("https://github.com/graalvm/graalvm-ce-builds/releases/tag/vm-22.3.1"),a(n)])]),C,e("p",null,[e("a",F,[i("https://my.visualstudio.com/Downloads?q=visual studio 2019&wt.mc_id=o~msft~vscom~older-downloads"),a(n)])]),P,e("p",null,[e("a",x,[i("https://start.spring.io/"),a(n)])]),S])}const B=s(b,[["render",j],["__file","2023032311.html.vue"]]);export{B as default};
