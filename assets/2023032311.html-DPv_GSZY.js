import{_ as r}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,o,c as d,b as i,d as n,e as s,f as a}from"./app-E1vXAF15.js";const m="/assets/img-20230413210618-q_PNOK-2.png",v="/assets/img-20230413210656-ApGS6evw.png",c="/assets/img-20230413210905-jEl4mdIm.png",u="/assets/img-20230413210932-Beff0MW_.png",g="/assets/img-20230413211241-DZS6uIsM.png",p="/assets/img-20230413211355-BbsBdfck.png",b="/assets/img-20230413211426-Dz6fCnAe.png",f={},w={href:"https://github.com/graalvm/graalvm-ce-builds/releases/tag/vm-22.3.1",target:"_blank",rel:"noopener noreferrer"},k={href:"https://my.visualstudio.com/Downloads?q=visual%20studio%202019&wt.mc_id=o~msft~vscom~older-downloads",target:"_blank",rel:"noopener noreferrer"},C={href:"https://start.spring.io/",target:"_blank",rel:"noopener noreferrer"};function F(P,e){const t=l("ExternalLinkIcon");return o(),d("div",null,[e[3]||(e[3]=i("p",null,"​",-1)),e[4]||(e[4]=i("figure",null,[i("img",{src:m,alt:"GraalVM",tabindex:"0",loading:"lazy"}),i("figcaption",null,"GraalVM")],-1)),e[5]||(e[5]=i("h2",{id:"一、下载安装graalvm",tabindex:"-1"},[i("a",{class:"header-anchor",href:"#一、下载安装graalvm","aria-hidden":"true"},"#"),n(" 一、下载安装GraalVM")],-1)),i("p",null,[i("a",w,[e[0]||(e[0]=n("https://github.com/graalvm/graalvm-ce-builds/releases/tag/vm-22.3.1",-1)),s(t)])]),e[6]||(e[6]=a('<figure><img src="'+v+`" alt="GraalVM Community Edition" tabindex="0" loading="lazy"><figcaption>GraalVM Community Edition</figcaption></figure><p>我下载的是当前最新的GraalVM Community Edition 22.3.1，选择的是Java 17。</p><p>下载好之后解压到本地随便一个目录（比如：D:\\software\\Java\\graalvm-ce-java17-22.3.1），并配置环境变量Path。</p><p>打开命令提示符，进入到jdk的bin目录，通过gu命令安装native-image。</p><div class="language-cmd line-numbers-mode" data-ext="cmd"><pre class="language-cmd"><code>C:\\Users\\Think&gt;D:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样也是可以的。</p><p>最终打出来的exe文件有65M，也不小，jar包的话也就18M，不过exe不需要jvm环境，并且启动后占用60M内存，而直接启动jar文件占用109M内存，相对来说还是有优势。</p>`,16))])}const h=r(f,[["render",F],["__file","2023032311.html.vue"]]);export{h as default};
