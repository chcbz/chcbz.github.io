import{_ as r,X as l,Y as d,a0 as e,a1 as n,$ as s,a2 as a,C as o}from"./framework-7dab1287.js";const t={},v=e("p",null,"​",-1),c=e("h2",{id:"summary",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#summary","aria-hidden":"true"},"#"),n(" Summary")],-1),u={href:"https://docs.gradle.org/current/userguide/java_platform_plugin.html",target:"_blank",rel:"noopener noreferrer"},m=e("code",null,"dependencyResolutionManagement",-1),b={href:"https://docs.gradle.org/current/userguide/platforms.html",target:"_blank",rel:"noopener noreferrer"},p={href:"https://zhuanlan.zhihu.com/p/570009095?utm_id=0",target:"_blank",rel:"noopener noreferrer"},h=a(`<h2 id="main-content" tabindex="-1"><a class="header-anchor" href="#main-content" aria-hidden="true">#</a> main content</h2><h3 id="parent-project-settings-gradle" tabindex="-1"><a class="header-anchor" href="#parent-project-settings-gradle" aria-hidden="true">#</a> parent project settings.gradle</h3><div class="language-Groovy line-numbers-mode" data-ext="Groovy"><pre class="language-Groovy"><code>rootProject.name = &#39;jia&#39;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>It is found that the output is <code>unspecified</code>, obviously the version has been defined in the build.gradle of the jia-core project, but why it cannot be recognized.</p><h2 id="problem-solved" tabindex="-1"><a class="header-anchor" href="#problem-solved" aria-hidden="true">#</a> problem solved</h2><p>Another round of various attempts, Gradle has very few guidance documents, and I really don’t want to go through the official Gradle website. I have defined version in allprojects , subprojects , ext of the parent project and allprojects , subprojects , ext of the subproject respectively. It is found that the version defined in the parent project can be recognized, but the version defined in the sub-project cannot be recognized. Then I accidentally saw a post saying that the loading order of Gradle is setting.gradle of the parent project -&gt; build.gradle of the parent project -&gt; build.gradle of the subproject. The subprojects are written on the build.gradle of the parent project, and the build.gradle of the subproject has not been loaded when loading, so naturally the version of the subproject cannot be obtained.</p>`,15),g={href:"https://docs.gradle.org/current/userguide/publishing_maven.html#publishing_maven:deferred_configuration",target:"_blank",rel:"noopener noreferrer"},f=a(`<p>Now that you know the reason, it’s easy to handle. Just wrap the publishing method with afterEvaluate. The purpose is to load all the configuration files and then load the publishing method, and you can get the version naturally.</p><div class="language-Groovy line-numbers-mode" data-ext="Groovy"><pre class="language-Groovy"><code>allprojects {
     group = &#39;cn.jia&#39;
}
