...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>设置后重启Apache服务器就大功告成了！</p><p>Update May 1, 2009</p><p>今天上网看到了有人提一个问题：</p>`,32),m={href:"http://xn--www-628dm0m194i.im286.com",target:"_blank",rel:"noopener noreferrer"},u={href:"http://www.chinaz.com",target:"_blank",rel:"noopener noreferrer"},v=s(`<p>论坛中的答案是：</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code>RewriteEngine On 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Update May 7, 2009</p>`,3),w={href:"http://lamp.linux.gov.cn/Apache/ApacheMenu/mod/mod_rewrite.html",target:"_blank",rel:"noopener noreferrer"},R=s(`<p>Update May 24, 2009</p><p>一、关于是否需要使用完全转义，比如在</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code>RewriteCond %{HTTP_REFERER} chinaz.com [NC]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>中 把 <code>chinaz.com</code> 改成 <code>chinaz.com</code></p><p>答案是，两者都是可以的。</p><p>二、今天在做 <code>YOURcaddy.com</code>（就是我去年做的PlanetCoachella的变形）的时候，在 GoDaddy 主机上无法正常转向，后来找到了问题： 在HostMonster以及我自己的机器上，是用</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code>RewriteRule ^business/([^.]+)$ biz/detail.php?name=$1 [L]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>目标文件前多了一个/ 现在想想，可能是因为没有指定RewriteBase，至于到底是不是，我改日再验证一下。</p><p>三、添加两个关于判断 USER AGENT 例子和自动添加.php扩展名及自动换.html到.php扩展名的例子： 1</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code>RewriteEngine on 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,22);function h(b,g){const i=r("ExternalLinkIcon");return d(),t("div",null,[n("p",null,[e("文章转自:"),n("a",o,[e("http://www1.360quan.com/blog/show/4823429"),a(i)])]),p,n("p",null,[e("求Rewrite 防盗链正则 "),n("a",m,[e("不允许www.im286.com"),a(i)]),e(),n("a",u,[e("www.chinaz.com"),a(i)]),e(" 这两个网站盗链, 其它的网站都可以盗链的规则怎么写.")]),v,n("p",null,[e("介绍一篇文章： "),n("a",w,[e("http://lamp.linux.gov.cn/Apache/ApacheMenu/mod/mod_rewrite.html"),a(i)])]),R])}const T=l(c,[["render",h],["__file","5542697.html.vue"]]);export{T as default};
