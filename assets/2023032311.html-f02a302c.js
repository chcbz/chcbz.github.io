...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>This is also possible.</p><p>The final exe file is 65M, which is not small, and the jar package is only 18M. However, the exe does not need a jvm environment and takes up 60M of memory after startup, while directly starting the jar file takes up 109M of memory, which is relatively advantageous.</p>`,16);function S(j,M){const n=l("ExternalLinkIcon");return r(),o("div",null,[f,h,w,e("p",null,[e("a",k,[i("https://github.com/graalvm/graalvm-ce-builds/releases/tag/vm-22.3.1"),t(n)])]),y,e("p",null,[e("a",F,[i("https://my.visualstudio.com/Downloads?q=visual studio 2019&wt.mc_id=o~msft~vscom~older-downloads"),t(n)])]),C,e("p",null,[e("a",x,[i("https://start.spring.io/"),t(n)])]),P])}const B=s(b,[["render",S],["__file","2023032311.html.vue"]]);export{B as default};
