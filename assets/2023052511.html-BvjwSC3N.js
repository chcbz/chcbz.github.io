import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as d,o,c as t,b as n,d as i,e as r,f as l}from"./app-E1vXAF15.js";const v={},u={href:"https://docs.gradle.org/current/userguide/java_platform_plugin.html",target:"_blank",rel:"noopener noreferrer"},c={href:"https://docs.gradle.org/current/userguide/platforms.html",target:"_blank",rel:"noopener noreferrer"},m={href:"https://zhuanlan.zhihu.com/p/570009095?utm_id=0",target:"_blank",rel:"noopener noreferrer"},b={href:"https://docs.gradle.org/current/userguide/publishing_maven.html#publishing_maven:deferred_configuration",target:"_blank",rel:"noopener noreferrer"};function p(h,e){const s=d("ExternalLinkIcon");return o(),t("div",null,[e[14]||(e[14]=n("p",null,"​",-1)),e[15]||(e[15]=n("h2",{id:"summary",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#summary","aria-hidden":"true"},"#"),i(" Summary")],-1)),n("p",null,[e[1]||(e[1]=i("Recently, I have been tossing about the unified management of Gradle's dependency versions, which is really a pitfall step by step. At the beginning, we turned to ChatGPT to provide two plug-ins, one is java-platform and the other is io.spring.dependency-management. I chose to use java-platform , but various attempts resulted in errors. If you are interested, you can take a look at the examples on the official website.",-1)),e[2]||(e[2]=n("br",null,null,-1)),n("a",u,[e[0]||(e[0]=i("https://docs.gradle.org/current/userguide/java_platform_plugin.html",-1)),r(s)])]),n("p",null,[e[4]||(e[4]=i("After several searches, I found that there is a new version management method ",-1)),e[5]||(e[5]=n("code",null,"dependencyResolutionManagement",-1)),e[6]||(e[6]=i(" after Gradle7. The official website introduces it as follows.",-1)),e[7]||(e[7]=n("br",null,null,-1)),n("a",c,[e[3]||(e[3]=i("https://docs.gradle.org/current/userguide/platforms.html",-1)),r(s)])]),n("p",null,[e[9]||(e[9]=i("But the introduction on the official website is too fragmented, so I googled it again and found the following post, which introduces it in great detail.",-1)),e[10]||(e[10]=n("br",null,null,-1)),n("a",m,[e[8]||(e[8]=i("https://zhuanlan.zhihu.com/p/570009095?utm_id=0",-1)),r(s)])]),e[16]||(e[16]=l(`<h2 id="main-content" tabindex="-1"><a class="header-anchor" href="#main-content" aria-hidden="true">#</a> main content</h2><h3 id="parent-project-settings-gradle" tabindex="-1"><a class="header-anchor" href="#parent-project-settings-gradle" aria-hidden="true">#</a> parent project settings.gradle</h3><div class="language-Groovy line-numbers-mode" data-ext="Groovy"><pre class="language-Groovy"><code>rootProject.name = &#39;jia&#39;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>It is found that the output is <code>unspecified</code>, obviously the version has been defined in the build.gradle of the jia-core project, but why it cannot be recognized.</p><h2 id="problem-solved" tabindex="-1"><a class="header-anchor" href="#problem-solved" aria-hidden="true">#</a> problem solved</h2><p>Another round of various attempts, Gradle has very few guidance documents, and I really don’t want to go through the official Gradle website.<br> I have defined version in allprojects , subprojects , ext of the parent project and allprojects , subprojects , ext of the subproject respectively. It is found that the version defined in the parent project can be recognized, but the version defined in the sub-project cannot be recognized.<br> Then I accidentally saw a post saying that the loading order of Gradle is setting.gradle of the parent project -&gt; build.gradle of the parent project -&gt; build.gradle of the subproject. The subprojects are written on the build.gradle of the parent project, and the build.gradle of the subproject has not been loaded when loading, so naturally the version of the subproject cannot be obtained.</p>`,15)),n("p",null,[e[12]||(e[12]=i("In fact, the official website also has an introduction, but the English is really bad and it is not easy to understand.",-1)),e[13]||(e[13]=n("br",null,null,-1)),n("a",b,[e[11]||(e[11]=i("https://docs.gradle.org/current/userguide/publishing_maven.html#publishing_maven:deferred_configuration",-1)),r(s)])]),e[17]||(e[17]=l(`<p>Now that you know the reason, it’s easy to handle. Just wrap the publishing method with afterEvaluate. The purpose is to load all the configuration files and then load the publishing method, and you can get the version naturally.</p><div class="language-Groovy line-numbers-mode" data-ext="Groovy"><pre class="language-Groovy"><code>allprojects {
     group = &#39;cn.jia&#39;
}
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2))])}const j=a(v,[["render",p],["__file","2023052511.html.vue"]]);export{j as default};
