...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>设置后重启Apache服务器就大功告成了！</p><p>Update May 1, 2009</p><p>今天上网看到了有人提一个问题：</p>`,32)),n("p",null,[e[4]||(e[4]=i("求Rewrite 防盗链正则",-1)),e[5]||(e[5]=n("br",null,null,-1)),n("a",m,[e[2]||(e[2]=i("不允许www.im286.com",-1)),s(l)]),e[6]||(e[6]=i()),n("a",u,[e[3]||(e[3]=i("www.chinaz.com",-1)),s(l)]),e[7]||(e[7]=i(" 这两个网站盗链, 其它的网站都可以盗链的规则怎么写.",-1))]),e[12]||(e[12]=a(`<p>论坛中的答案是：</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code>RewriteEngine On 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Update May 7, 2009</p>`,3)),n("p",null,[e[9]||(e[9]=i("介绍一篇文章：",-1)),e[10]||(e[10]=n("br",null,null,-1)),n("a",v,[e[8]||(e[8]=i("http://lamp.linux.gov.cn/Apache/ApacheMenu/mod/mod_rewrite.html",-1)),s(l)])]),e[13]||(e[13]=a(`<p>Update May 24, 2009</p><p>一、关于是否需要使用完全转义，比如在</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code>RewriteCond %{HTTP_REFERER} chinaz.com [NC]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,22))])}const h=d(p,[["render",w],["__file","5542697.html.vue"]]);export{h as default};
